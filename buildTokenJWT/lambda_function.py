...
def lambda_handler(event, context):
    ...
    video_key = event['queryStringParameters']['media_id']  # used if video is in query params
    playlist_key = event['queryStringParameters']['playlist_id'] # used if playlist is in query params
    player_key = event['queryStringParameters']['player_id']  # always used, specifies player
